...
export const metadata = {
  ...
  description: "Carroattrezzi a Ferrara per traino auto, recupero veicoli, assistenza stradale e trasporto verso officina. Intervento rapido, chiama 0532 080206.",
};
